import { View, Text, TouchableOpacity, ScrollView, TouchableNativeFeedback,Dimensions,Image } from 'react-native'
                    ...
                    return(
                        <TouchableNativeFeedback key={index} onPress={()=> navigation.push("Movie",item)}>
                            <View className="space-y-1 mr-4">
                                <Image source={require('../assets/icon.png')} className="rounded-3xl" style={{width:width*0.33,height:height*0.22}}/>
